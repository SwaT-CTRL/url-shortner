...
<head>
    ...
    <title>@yield('title', 'Member Panel') | URL Shortner</title>
    ...
    <style>
        :root {
            ...
            --content-bg: #0d1117; --primary: #a855f7; --text: #e2e8f0; --text-muted: #64748b;
            --text-sub: #94a3b8; --border: rgba(255,255,255,0.08); --card-bg: #161d2f; --card-border: rgba(255,255,255,0.07);
            --success: #34d399; --danger: #f87171; --primary-glow: rgba(168, 85, 247, 0.3);
        }
