...
<div style="margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem;">
    <div>
        <h1 style="font-size: 1.25rem; font-weight: 700; margin-bottom: 0.5rem;">My Links</h1>
        <form action="{{ route('member.urls.index') }}" method="GET" id="filterForm" style="display: flex; align-items: center; gap: 0.5rem;">
            ...
            <a href="{{ route('member.urls.pdf', ['filter' => request('filter')]) }}" style="padding: 0.45rem 1rem; background: var(--primary); color: #fff; border-radius: 8px; font-size: 0.85rem; font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: background 0.2s;">
                <i class="fa-solid fa-file-pdf"></i> Download PDF
            </a>
        </form>
    </div>
    <a href="{{ route('member.urls.generate') }}" style="font-size: 0.85rem; color: var(--primary); font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 0.4rem;">
    ...
    <div class="dash-card-body" style="padding: 0;">
        <table style="width: 100%; border-collapse: collapse; font-size: 0.875rem;">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="padding: 2rem; text-align: center; color: var(--text-muted);">No links generated yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
